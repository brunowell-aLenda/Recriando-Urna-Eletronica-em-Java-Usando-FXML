...
public class ControllerTelaPresidente implements Initializable {
         ...
         c2.addEventHandler(KeyEvent.KEY_PRESSED, (KeyEvent t) -> {
             if (t.getCode() == KeyCode.ENTER) {
                 if(c2.getText().length() == 1){
                      ...
                      limparCampos();
                      MainApp.carregaScene("VICEPRESIDENTE");
    ...
    public void chamaCandidato(){
        ...
        PresidenteDAO votoDAO = new PresidenteDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarPresidente(numero); 
      ...
      if(lista.isEmpty()){
         lbNomeCandidato.setText("NULO");
          ...
          //lbNomePartido.setText(lista.get(0).getPartido());
