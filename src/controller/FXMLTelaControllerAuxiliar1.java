...
public class FXMLTelaControllerAuxiliar1 implements Initializable {
         ...
         c2.addEventHandler(KeyEvent.KEY_PRESSED, (KeyEvent t) -> {
             if (t.getCode() == KeyCode.ENTER) {
                 if(c2.getText().length() == 1){
                      ...
                      limparCampos();
                      MainApp.carregaScene("AUXILIAR2");
    ...
    public void chamaCandidato(){
      ...
      Connection con = Conexao.abrirConexao();
        Auxiliar1DAO votoDAO = new Auxiliar1DAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarAuxiliar1(numero); 
