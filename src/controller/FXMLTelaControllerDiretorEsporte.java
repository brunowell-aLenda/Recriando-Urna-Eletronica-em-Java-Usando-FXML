...
public class FXMLTelaControllerDiretorEsporte implements Initializable {
    ...
    Connection con = Conexao.abrirConexao();
        DiretorEsporteDAO votoDAO = new DiretorEsporteDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarEsporte(numero); 
