...
import dao.Conexao;
import dao.DiretorMarkentDAO;
import dao.SocioCulturalDAO;
import java.net.URL;
...
public class FXMLTelaControllerDiretorMarkent implements Initializable {
         ...
         c2.addEventHandler(KeyEvent.KEY_PRESSED, (KeyEvent t) -> {
             if (t.getCode() == KeyCode.ENTER) {
                 if(c2.getText().length() == 1){
                      ...
                      limparCampos();
                      MainApp.carregaScene("AUXILIAR1");
    ...
    public void chamaCandidato(){
      ...
      Connection con = Conexao.abrirConexao();
        DiretorMarkentDAO votoDAO = new DiretorMarkentDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarMarkent(numero); 
