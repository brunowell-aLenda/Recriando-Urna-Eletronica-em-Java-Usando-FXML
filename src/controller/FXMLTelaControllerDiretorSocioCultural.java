...
public class FXMLTelaControllerDiretorSocioCultural implements Initializable {
         ...
         c2.addEventHandler(KeyEvent.KEY_PRESSED, (KeyEvent t) -> {
             if (t.getCode() == KeyCode.ENTER) {
                 if(c2.getText().length() == 1){
                      ...
                      limparCampos();
                      MainApp.carregaScene("TESOUREIRO");
    ...
    public void chamaCandidato(){
      ...
      Connection con = Conexao.abrirConexao();
        SocioCulturalDAO votoDAO = new SocioCulturalDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarCultural(numero); 
