...
public class FXMLTelaControllerOrador implements Initializable {
    ...
    Connection con = Conexao.abrirConexao();
        OradorDAO votoDAO = new OradorDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarOrador(numero); 
