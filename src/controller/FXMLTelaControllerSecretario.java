...
public class FXMLTelaControllerSecretario implements Initializable {
    ...
    public void chamaCandidato(){
     ...
     Connection con = Conexao.abrirConexao();
        SecretarioDAO votoDAO = new SecretarioDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarSecretario(numero); 
