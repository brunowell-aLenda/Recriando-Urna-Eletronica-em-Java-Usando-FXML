...
public class FXMLTelaControllerTesoureiro implements Initializable {
    ...
    public void chamaCandidato(){
      ...
      Connection con = Conexao.abrirConexao();
        TesoureiroDAO votoDAO = new TesoureiroDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarTesoureiro(numero); 
