...
public class FXMLTelaControllerVice implements Initializable {
         ...
         c2.addEventHandler(KeyEvent.KEY_PRESSED, (KeyEvent t) -> {
             if (t.getCode() == KeyCode.ENTER) {
                 ...
                 if(c2.getText().length() == 1){
                    ...
                    MainApp.carregaScene("SECRETARIO");
    ...
    public void chamaCandidato(){
      ...
      Connection con = Conexao.abrirConexao();
        ViceDAO votoDAO = new ViceDAO(con);
      ...
      lista = (ArrayList<Candidato>) votoDAO.consultarVice(numero); 
